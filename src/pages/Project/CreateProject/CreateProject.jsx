...
const CreateProject = () => {
    ...
    return (
        <div>
            ...
            <Form name="product_form" layout="vertical" onFinish={onFinish}>
                <Row justify="end">
                ...
                <Row gutter={16}>
                    <Col span={12} xs={24} sm={12} md={24} lg={12} xl={12}>
                        ...
                        <Form.Item
                            ...
                            rules={[
                                { required: true, message: "Please select product technical!" },
                            ]}
                        >
                    ...
                    <Col span={12} xs={24} sm={12} md={24} lg={12} xl={12}>
                        <Form.Item
                            ...
                            rules={[
                                { required: true, message: "Please enter project time!" },
                            ]}
                        >
                        ...
                        <Form.Item
                            ...
                            rules={[
                                { required: true, message: "Please select product manager!" },
                            ]}
                        >
                ...
                <Row gutter={16}>
                    <Col span={12} xs={24} sm={12} md={24} lg={12} xl={12}>
                        <Form.Item
                            ...
                            rules={[
                                { required: true, message: "Please select product member!" },
                            ]}
                        >
                    ...
                    <Col span={12} xs={24} sm={12} md={24} lg={12} xl={12}>
                        <Form.Item
                            ...
                            rules={[
                                { required: true, message: "Please select product role!" },
                            ]}
                        >
